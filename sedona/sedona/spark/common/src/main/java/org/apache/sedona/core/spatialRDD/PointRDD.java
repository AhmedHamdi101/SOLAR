...
public class PointRDD extends SpatialRDD<Point> {
  ...
  //newly added constructor, used to avoid scanning the data to get the boundary 
  public PointRDD(
      JavaSparkContext sparkContext,
      String InputLocation,
      Integer Offset,
	...
	this.boundaryEnvelope = new Envelope(-20040000, 20040000, -20040000, 20040000);
  }	
