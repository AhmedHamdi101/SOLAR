...
def run_scenario(dataset_dirs, distance, grid, selector, percentages, debug, experiment_mode, seed=2024):
    for percentage in percentages:
        ...
        join_optimizer.offline_partitioning(joins_seen, distance, [grid], debug)
...
if __name__ == "__main__":
    ...
    run_scenario(["/dataset_china","/dataset_us","/dataset_world","/dataset_other"], distance,  default_grid, selector, percentages, debug, experiment_mode, seed)
